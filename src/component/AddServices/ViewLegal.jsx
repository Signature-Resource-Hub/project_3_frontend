...
const ViewLegal = () => {
    ...
    useEffect(()=>{
        const getData =async()=>{
            try{
                const response=await axios.get("http://localhost:8000/api/household-services/661e38aa63f42abea7c9b81a");
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="https://tse1.mm.bing.net/th?id=OIP.NJPNAu1veP1eZcsM2zmtZAHaCq&pid=Api&P=0&h=180" class="d-block w-100" alt="..."/>
                            ...
                            
                            {
                                data.map(
                                    (value,index)=>{
                                        ...
                                        <div className="card">
                                            <img src="https://www.proposalkit.com/img/samples/19_5_a_1200.jpg" className="card-img-top" alt="..." />
